        ...
        <div class="col-12 col-lg-7 ">
            <div class="right-single-content">
                ...
                <div class="photo-count-wrap single-photo-count-wrap d-flex">
                    ...
                    <span class="photo-count single-photo-count"> Фото +30</span>
                </div>
                ...
                <div class="metro-wrap d-flex">
                    ...
                    <div class="metro-name">Авиамоторная</div>
                </div>
                <div class="metro-wrap d-flex">
                ...
                <div class="metro-wrap d-flex">
                    <div class="metro-label">Место встречи:</div>
                    <div class="metro-name">Выезд</div>
                </div>
                <div class="metro-wrap d-flex">
                    <div class="metro-label">Национальность:</div>
                    <div class="metro-name">Русская</div>
                </div>
                <div class="price-container">
                    <div class="price-block">
                        <div class="price-list">
                            ...
                            <div class="price-row">
                                ...
                                <div class="price-value">6000 ₽</div>
                            </div>
                            <div class="price-row">
                                <div class="price-label">Ночь:</div>
                                <div class="price-value">12000 ₽</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="price-block">
                        <div class="price-list">
                            ...
                            <div class="price-row">
                                <div class="price-label">Час:</div>
                                <div class="price-value">4000 ₽</div>
                            </div>
                            <div class="price-row">
                                <div class="price-label">Два часа:</div>
                                <div class="price-value">8000 ₽</div>
                            </div>
                            <div class="price-row">
                                <div class="price-label">Ночь:</div>
                                <div class="price-value">16000 ₽</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12 single-other-info">
            <div class="profile-card">
                <div class="profile-header d-flex">
                    <img src="/img/img.png" alt="{{ $post->name }}" class="profile-avatar">
                    <div class="name-info-wrap d-flex">
                        <div class="profile-name">{{ $post->name }}</div>
                        <div class="profile-info">
                            <div class="info-item">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                    <path d="M4.50473 5.92084H3.14285C3.0272 5.92084 2.93359 6.01445 2.93359 6.1301V7.49197C2.93359 7.60748 3.0272 7.70123 3.14285 7.70123H4.50473C4.62038 7.70123 4.71399 7.60748 4.71399 7.49197V6.1301C4.71399 6.01459 4.62038 5.92084 4.50473 5.92084ZM4.29547 7.28271H3.35212V6.33936H4.29547V7.28271Z" fill="#F74952"/>
                                    <path d="M7.68051 5.92084H6.31864C6.20298 5.92084 6.10938 6.01445 6.10938 6.1301V7.49197C6.10938 7.60748 6.20298 7.70123 6.31864 7.70123H7.68051C7.79602 7.70123 7.88977 7.60748 7.88977 7.49197V6.1301C7.88977 6.01459 7.79602 5.92084 7.68051 5.92084ZM7.47125 7.28271H6.5279V6.33936H7.47125V7.28271Z" fill="#F74952"/>
                                    <path d="M10.7586 5.92084H9.39676C9.28125 5.92084 9.1875 6.01445 9.1875 6.1301V7.49197C9.1875 7.60748 9.28125 7.70123 9.39676 7.70123H10.7586C10.8741 7.70123 10.9679 7.60748 10.9679 7.49197V6.1301C10.9679 6.01459 10.8741 5.92084 10.7586 5.92084ZM10.5494 7.28271H9.60602V6.33936H10.5494V7.28271Z" fill="#F74952"/>
                                    <path d="M4.50473 9.02295H3.14285C3.0272 9.02295 2.93359 9.1167 2.93359 9.23221V10.5941C2.93359 10.7096 3.0272 10.8033 3.14285 10.8033H4.50473C4.62038 10.8033 4.71399 10.7096 4.71399 10.5941V9.23221C4.71399 9.1167 4.62038 9.02295 4.50473 9.02295ZM4.29547 10.3848H3.35212V9.44147H4.29547V10.3848Z" fill="#F74952"/>
                                    <path d="M7.68051 9.02295H6.31864C6.20298 9.02295 6.10938 9.1167 6.10938 9.23221V10.5941C6.10938 10.7096 6.20298 10.8033 6.31864 10.8033H7.68051C7.79602 10.8033 7.88977 10.7096 7.88977 10.5941V9.23221C7.88977 9.1167 7.79602 9.02295 7.68051 9.02295ZM7.47125 10.3848H6.5279V9.44147H7.47125V10.3848Z" fill="#F74952"/>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path d="M11.8225 0L0 11.8225L3.79752 15.62L15.62 3.79752L11.8225 0ZM3.79752 14.7751L0.844889 11.8225L1.68679 10.9776L2.73469 12.0315L3.15565 11.6105L2.10177 10.5536L2.94666 9.70876L4.4394 11.2015L4.85438 10.7656L3.36164 9.28781L4.22743 8.44292L5.2813 9.49978L5.70524 9.07584L4.64838 8.02197L5.49327 7.17708L6.98601 8.65489L7.40995 8.23095L5.93214 6.75314L6.77404 5.91124L7.81 6.96511L8.23095 6.54416L7.17708 5.4873L8.02197 4.64241L9.49978 6.12022L9.92073 5.69927L8.42799 4.22146L9.30274 3.37657L10.3596 4.43343L10.7805 4.00949L9.72369 2.95562L10.5686 2.11073L12.0613 3.58854L12.4853 3.1646L10.9925 1.67187L11.8374 0.829962L14.79 3.7826L3.79752 14.7751Z" fill="#F74952"/>
                                </svg>
                                <span>175 см</span>
                            </div>
                            <div class="info-item">
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                                    <g clip-path="url(#clip0_220_356)">
                                        <path d="M15.5059 0H1.49414C0.670288 0 0 0.670288 0 1.49414V15.5059C0 16.3297 0.670288 17 1.49414 17H15.5059C16.3297 17 17 16.3297 17 15.5059V1.49414C17 0.670288 16.3297 0 15.5059 0ZM16.0039 15.5059C16.0039 15.7804 15.7804 16.0039 15.5059 16.0039H1.49414C1.21957 16.0039 0.996094 15.7804 0.996094 15.5059V1.49414C0.996094 1.21957 1.21957 0.996094 1.49414 0.996094H15.5059C15.7804 0.996094 16.0039 1.21957 16.0039 1.49414V15.5059Z" fill="#F74952"/>
                                        <path d="M14.2442 3.97283C12.5744 2.72058 10.588 2.05859 8.50001 2.05859C6.41198 2.05859 4.42563 2.72058 2.75587 3.97283C2.65017 4.05221 2.58026 4.17023 2.56158 4.3011C2.54303 4.43197 2.57715 4.56491 2.65652 4.67062L5.28566 8.16836C5.38359 8.29858 5.533 8.36719 5.68423 8.36719C5.78812 8.36719 5.89305 8.33476 5.98267 8.26758C6.71444 7.71882 7.58485 7.42868 8.50001 7.42868C9.41504 7.42868 10.2856 7.71882 11.0174 8.26758C11.2372 8.43256 11.5491 8.38807 11.7142 8.16836L14.3434 4.67062C14.4229 4.56491 14.457 4.43197 14.4383 4.3011C14.4198 4.17036 14.3499 4.05221 14.2442 3.97283ZM11.203 7.19081C10.5311 6.77966 9.78248 6.53064 8.99806 6.45645V4.93845C8.99806 4.66335 8.7751 4.4404 8.50001 4.4404C8.22492 4.4404 8.00196 4.66335 8.00196 4.93845V6.45645C7.21754 6.53064 6.46891 6.77966 5.79707 7.19081L3.76091 4.4819C5.16803 3.54664 6.79628 3.05469 8.50001 3.05469C10.2037 3.05469 11.832 3.54664 13.2391 4.4819L11.203 7.19081Z" fill="#F74952"/>
                                    </g>
                                    <defs>
                ...
                <div class="profile-details">
                    <div class="profile-row">
                        <span class="label">Место встречи:</span> Апартаменты, выезд в дом, сауны, гостиницы.
                    </div>
                    <div class="profile-row">
                        <span class="label">Услуги:</span> Уборка, готовка, и тд
                    </div>
                    <div class="profile-row">
                        <span class="label">Описание:</span> убираю и готовлю круглый год и день
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="review-wrap">
                ...
                <div class="review-card">
                    <div class="review-header">
                        ...
                        <div class="user-info">
                            <div class="username">Anonymous <span class="hidden-icon">🔒</span></div>
                            <div class="rating">
                                ★★★★★
                            </div>
                        </div>
                ...
                <form action="" class="add-review">
                    ...
                    <input placeholder="Имя" type="text" class="review-input">
