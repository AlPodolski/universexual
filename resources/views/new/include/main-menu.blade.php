...
<div class="side-menu" id="side-menu">
    ...
    <nav>
        <ul class="side-menu-list">
            ...
            <li><a href="/" class="side-menu-link">Дешевые</a></li>
            <li><a href="/" class="side-menu-link">Проверенные</a></li>
            <li><a href="/" class="side-menu-link">VIP</a></li>
            <li><a href="/" class="side-menu-link">С видео</a></li>
            <li><a href="/" class="side-menu-link">Новые</a></li>
