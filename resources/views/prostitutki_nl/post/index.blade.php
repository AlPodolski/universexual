            ...
            <div class="right">
                ...
                <div class="bold-text single-price m-bottom-20">
                    ...
                    <div class="exit-column">
                        ...
                        <div class="time-column-item">{{ $post->exit_1_hour_price }}</div>
                        <div class="time-column-item">{{ $post->exit_2_hour_price }}</div>
                        <div class="time-column-item">{{ $post->exit_night_price }}</div>
                    </div>
                </div>
