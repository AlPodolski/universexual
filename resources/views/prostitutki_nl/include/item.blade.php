        ...
        <div class="name-wrap">
            ...
            @if($metro = $post->metro->first())
                <div class="catalog-metro bold-text">
                    <a href="/{{ $metro->metro_url }}"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0" viewBox="0 0 95.334 95.334" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="M47.784 0C21.447 0 0 21.449 0 47.904c0 26.215 21.447 47.43 47.784 47.43s47.55-21.098 47.55-47.43C95.334 21.449 73.168 0 47.784 0zm0 89.011c-22.639 0-41.229-18.465-41.229-41.106 0-22.757 18.591-41.591 41.229-41.591 22.526 0 40.995 18.95 40.995 41.591 0 22.404-18.468 41.106-40.995 41.106z" fill="#ed0d0d" data-original="#000000" class=""></path><path d="M66.139 22.644c-2.973 0-4.17 1.311-5.479 3.934L47.787 53.389h-.117L34.68 26.577c-1.313-2.624-2.502-3.934-5.482-3.934-3.932 0-5.244 2.502-5.244 4.884v41.587c0 2.27 1.791 3.575 3.932 3.575 1.906 0 4.051-1.306 4.051-3.575v-30.98h.121l11.797 24.071c.835 1.668 1.91 2.626 3.816 2.626 1.901 0 2.979-.958 3.813-2.626l11.795-24.071h.121v30.98c0 2.27 2.143 3.575 4.05 3.575 2.147 0 3.932-1.306 3.932-3.575V27.528c-.001-2.382-1.308-4.884-5.243-4.884z" fill="#ed0d0d" data-original="#000000" class=""></path></g></svg>
                        {{ $metro->metro_value }}</a>
                </div>
            @endif
